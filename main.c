...
int main(void)
{
  ...
  MX_USART2_UART_Init();
  /* USER CODE BEGIN 2 */
#define WHEEL_CIRCUMFERENCE_MM   62.8f   // pi * your pulley diameter -- measure it
#define PULSES_PER_REV           8       // however many stripes/slots you put on the disc
Motor_HandleTypeDef hConveyor;

hConveyor.htim         = &htim3;
hConveyor.rpwm_channel = TIM_CHANNEL_1;
hConveyor.lpwm_channel = TIM_CHANNEL_2;
hConveyor.ren_port = GPIOB;  hConveyor.ren_pin = GPIO_PIN_4;
